...
Cada funcionalidade possui documentação completa de:

Complexidade de tempo (melhor, médio e pior caso)
Complexidade de espaço
Justificativa das escolhas de algoritmos
Equações de recorrência para funções recursivas

🎓 Objetivo Acadêmico
Projeto desenvolvido para demonstrar conhecimentos em:

Estruturas de dados (arrays, listas, tabelas hash)
